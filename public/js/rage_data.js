...
(function() {
  ...
  ENGINE.Rage_Letter_Mod_Container = (function(_super) {
    __extends(Rage_Letter_Mod_Container, _super);

    function Rage_Letter_Mod_Container() {
      return Rage_Letter_Mod_Container.__super__.constructor.apply(this, arguments);
    }

    return Rage_Letter_Mod_Container;

  })(Array);

  ENGINE.Rage_Letter_Mod = (function() {
    var DISTORT, EXPAND, LIVE_LONGER, RAND_RGB, SHRINK, WIREFRAME;

    Rage_Letter_Mod.prototype.letter = void 0;

    Rage_Letter_Mod.prototype.type = void 0;

    Rage_Letter_Mod.prototype.applied = false;

    function Rage_Letter_Mod(letter) {
      this.letter = letter;
    ...
    Rage_Letter_Mod.prototype.lifespan = function() {
      return this.letter.lifespan;
    };

    Rage_Letter_Mod.prototype.time_passed = function() {
      return this.letter.time_passed;
    };

    Rage_Letter_Mod.prototype.model = function() {
      return this.letter.model;
    };
    ...
    Rage_Letter_Mod.prototype.assign_type = function() {
      return this.type = _.sample([WIREFRAME]);
    };

    Rage_Letter_Mod.prototype.remove_self = function() {
      return this.letter.mods = _.reject(this.letter.mods, function(elem) {
        return elem === this;
      });
    };

    Rage_Letter_Mod.prototype.apply = function() {
    ...
    Rage_Letter_Mod.prototype.apply_scale = function(shrink_scale) {
      var model;
      model = this.model();
    ...
    return Rage_Letter_Mod;

  })();

  ENGINE.Rage_Letter = (function(_super) {
    __extends(Rage_Letter, _super);

    Rage_Letter.prototype.lifespan = void 0;

    Rage_Letter.prototype.time_passed = 0;

    Rage_Letter.prototype.letter = 'X';

    Rage_Letter.prototype.mods = [];

    Rage_Letter.get_random_letter = function() {
      var rl;
      rl = _.sample(ENGINE.rage_letters);
      return rl;
    };

    function Rage_Letter(args) {
      ...
      Rage_Letter.__super__.constructor.call(this, args);
    }

    Rage_Letter.prototype.full_remove = function() {
      ENGINE.threeScene.remove(this.model);
      return this.remove();
    };

    Rage_Letter.prototype.time_left = function() {
      return this.lifespan - this.time_passed;
    };

    Rage_Letter.prototype.step = function(delta) {
      if (this.time_left() < 0) {
        this.full_remove();
      }
      if (this.time_left() > 0) {
    ...
    Rage_Letter.prototype.render = function() {
    ...
    Rage_Letter.prototype.has_mods = function() {
      return this.mods.length > 0;
    };

    Rage_Letter.prototype.apply_mods = function() {
    ...
    Rage_Letter.prototype.add_random_modifier = function() {
      return this.mods.push(new ENGINE.Rage_Letter_Mod(this));
    };
